...
//  * }
//  */
// export function RestController(baseUrl: string, midwares?: Function[]) {
...
//  */
// export let GetMapping = MethodFactory('get');
...
//
// // @RestController("/xhr/user")
// // class UserController{
// //
// //     @GetMapping('/getUserInfo.do')
// //     getUserInfo( @PathParam('id') id: string, @QueryParam('name') name: string) {
// //         return [id, name]
// //     }
// // }
